...
2. Logo / Brand Link
  - `<a href="index.html" class="brand-link"><img src="dist/img/AdminLTELogo.png" alt="Credit Management Logo" class="brand-image img-circle elevation-3" style="opacity: .8"><span class="brand-text font-weight-light">Credit Management</span></a>` replaces the old logo
3. Sidebar
