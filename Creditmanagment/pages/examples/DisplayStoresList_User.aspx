                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div style="-ms-flex: 0 0 60%; flex: 0 0 250%; max-width: 60%;">
                               ...
                               <asp:GridView ID="gdDisplayStores" style="text-align:center;width: 515px;" runat="server" CellPadding="7" AutoGenerateColumns="false">
                                  <Columns>
                                  ...
                                  <asp:BoundField HeaderText="Helpline No" DataField="Mobile_No" />
