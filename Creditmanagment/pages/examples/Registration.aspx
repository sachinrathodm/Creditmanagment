<%@ Page Title="" Language="C#" MasterPageFile="~/BlankPage.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Creditmanagment.pages.examples.Registration" %>
        ...
        <div class="register-box">
            ...
            <div class="card">
                <div class="card-body register-card-body">
                    <p style="font-size: large">Register a new membership</p>
                    ...
                    <form action="../../index.html" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <asp:Button ID="btnRegister" EnableViewState="true" UseSubmitBehavior="false" runat="server" Text="Register" class="btn btn-primary btn-block" />
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
                    ...
                    <a href="login.html" style="font-size: large">I already have a membership</a>
                </div>
                <!-- /.form-box -->
            </div>
            <!-- /.card -->
